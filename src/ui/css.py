...
def inject_css():
    ...
    <style>
        ...
        .progress-container:hover {
            box-shadow: 0 6px 20px 0 rgba(31, 38, 135, 0.4), 0 0 30px rgba(0, 210, 255, 0.3);
        }
        ...
        .progress-container:hover .progress-bar {
            box-shadow: 0 0 30px rgba(0, 210, 255, 0.6), 0 0 40px rgba(58, 123, 213, 0.4);
        }
        ...
        .stats-badge {
            ...
            font-weight: bold;
            margin: 5px;
            box-shadow: 0 4px 15px 0 rgba(0, 210, 255, 0.4), 0 0 20px rgba(0, 210, 255, 0.3);
            transition: all 0.3s ease;
            cursor: pointer;
        }
        ...
        .stats-badge:hover {
            ...
            box-shadow: 0 6px 20px 0 rgba(0, 210, 255, 0.6), 0 0 40px rgba(0, 210, 255, 0.5), 0 0 60px rgba(58, 123, 213, 0.4);
